...
variable "db_backup_size" {
  default = 50
}
variable "DBImage" {
  # 11g
  #default = "ocid1.image.oc1.phx.aaaaaaaagg4s5jdv3wxxwyonp2n45pzzrfyfqzkiur6i3tsajqt6dxxswila"
  # 19c
  default = "ocid1.image.oc1.phx.aaaaaaaaithxpivh4mgvoqqv7qw5wb74gde4wy4sph5fyufxjyj3tkpn6cea"
}
variable "DBShape" {
